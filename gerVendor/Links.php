...
class Links
{
    ...
    protected $fecha = '19 de Setiembre de 2020';
    protected $title = 'Está bien no estar bien';
    ...
    protected $fecha2 = '26 de Setiembre de 2020';
    protected $title2 = 'Prisionero de esperanza';
