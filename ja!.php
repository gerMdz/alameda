...
<head>
    ...
    <meta property="og:url" content="https://www.iglesiaalameda.com/ja!.php" />
    <meta property="og:image" content="https://www.iglesiaalameda.com/imagenes/meta/auditorio.png">

    <title>JA! - Iglesia Alameda </title>
...
<!--    <link rel="stylesheet" href="css/estiloHorarios.css?v=--><?php //echo $version ?><!--" rel="stylesheet">-->
    ...
    <!-- Custom styles for this template -->
    <link href="css/landings/agency.min.css" rel="stylesheet">
    ...
    <section class="p5-5 mt-0 section-ja blog-post  mt-0" id="sabado_20190622">
        ...
        <div class="row fullscreen align-items-center justify-content-center">
            <div class="post mt-0 col-12">
                <img src="images/masporhacer/choque-ideas-2019-06-22.jpg"
...
<!--        <div class="container">-->
            <div class="row fullscreen align-items-center justify-content-center">
    <div class="post mt-0 col-12">
        <img src="images/ja_gris.png" class="img-fluid">
...
<!--            </div>-->
    ...
    <section class="p-5 mt-0 section-ja blog-post  mt-0" id="post-2">
        ...
        <div class="row fullscreen align-items-center justify-content-center">
            <div class="post mt-0 col-12">
        <img src="images/JA_abril_24.jpeg" class="img-fluid">
