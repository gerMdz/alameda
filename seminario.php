...
<hr/>
        ...
        <div class="section-title text-center">
            ...
            <p class="separator">  de manera urgente, nuevas iglesias con la
                ...
                Para esta misión el recurso mas valioso de Dios son hombres y mujeres capacitados para un liderazgo estratégico innovador y valiente.<br/>
                Para colaborar con Dios y servir  a la próxima generación, presentamos el Seminario de Liderazgo Alameda, un espacio de entrenamiento para jóvenes líderes, pastores y plantadores de iglesias. Nuestro enfoque es en tres áreas específicas:</p>
...
<section class="section bg-white p-5 mt-2" id="contenido">
    <!-- Card deck -->
    <div class="card-deck">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="team-block bottom">
            <img src="images/pastores/abel-schwab.jpeg" class="img-responsive rounded-circle img-fluid" alt="img">
