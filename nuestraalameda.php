...
<!--              <h6 class="card-img-top ">Domingos<br/> 10hs y 20hs</h6><br/>-->
<!--              <h5>San Martín 2020 de la Ciudad de Mendoza</h5>-->
          ...
          <div class="mdl-card something-else mdl-cell mdl-cell--8-col mdl-cell--4-col-desktop">
            ...
            <div class="mdl-card__title bg-white mdl-color--white mdl-color-text--grey-600">
              <img class="card card-img-top h-100 w-100" src="images/lenguaje_senias.jpg">
...
<!--                    </small>-->
            ...
            <div class="mdl-card amazing mdl-cell mdl-cell--12-col sin-iconos " id="ja">
                ...
                <div class="mdl-card__title mdl-color-text--grey-50">
                <span class="fa-stack list-inline compuesto" >
                    <img src="images/ja_gris.png" class="img-fluid rounded rounded-circle" style="z-index: 1000">
                </span>
...
<!--                        <span>Coordinadora: Paola Botacaulli </span>-->
            ...
            <div class="mdl-card amazing mdl-cell mdl-cell--12-col sin-iconos " id="puntodepartida">
                ...
                <div class="mdl-card__title mdl-color-text--grey-50">
                <span class="fa-stack list-inline compuesto" >
                    <img src="images/PEncuentroSinText.png" class="img-fluid " style="z-index: 1000">
                </span>
...
<!--                  <span class="mdl-button mdl-button--icon mdl-js-button  material-icons  modal__close">close</span>-->
              ...
              <div class="modal__text">
                  <img src="images/diagrama_auditorio.png" class="rounded card-img">
              </div>
