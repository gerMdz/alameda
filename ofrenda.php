...
<head>
    ...
    Ofrendas y Diezmos,
    Iglesia Alameda, Iglesia de la Alameda PIB, Ofrendas de Fe ">
            ...
            <div class="col-lg-3 col-md-6 mb-5 mx-auto">
                <div class="card h-90">
                    <div class="card-body">
                        ...
                        <h3 class="card-text">Realizando una transferencia bancaria: <br/>
                    ...
                    <div class="card-body">
                        ...
                        <h3 class="card-text">
                            ...
                            <br/> También puede escribir a <br/><a href="mailto:finanzas@primeramendoza.com.ar"><i
                                        class="fa fa-envelope"></i> finanzas@primeramendoza.com.ar</a></h3>
                    </div>
                </div>
            </div>
