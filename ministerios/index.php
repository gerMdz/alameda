...
<section class="page-section cta fondo-evento" id="campania">
            <div id="elCielo" class="carousel slide" data-ride="carousel">
                ...
                <ul class="carousel-indicators">
                    ...
                    <li data-target="#elCielo" data-slide-to="2"></li>
                    <li data-target="#elCielo" data-slide-to="3"></li>
                    <li data-target="#elCielo" data-slide-to="4"></li>
                </ul>
                ...
                <div class="carousel-inner ">
                    ...
                    <div class="carousel-item ">
                        <img src="imagenes/slider/navidad-lo-cambia-todo.png " alt="La Alameda" class="img-fluid " >
                    </div>
                    <div class="carousel-item ">
                        <img src="imagenes/slider/navidad2018_index.png" alt="La Alameda" class="img-fluid " >
                    </div>
                    <div class="carousel-item ">
                        <img src="imagenes/slider/esteNinio_lct.png" alt="La Alameda" class="img-fluid " >
                    </div>
                    <div class="carousel-item ">
